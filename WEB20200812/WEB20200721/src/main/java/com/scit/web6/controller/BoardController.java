...
public class BoardController {
	...
	public String boardList(
		...
		//전체 글 개수 조회(검색을 했을 때도 검색에 해당하는 글의 전체 개수도 조회할 수 있어야 함.)
	 ...
	 * 
	 * ArrayList<HashMap<String, Object>> list = service.searchBoard(searchText,
	 * searchType); model.addAttribute("list", list);
	 * 
	 * return "board/boardList"; }
	 */
	...
	public String fileDownload(int board_no, HttpServletResponse response) {
		...
		FileInputStream filein = null;			//물리적인 공간에 파일을 WebApplication으로 가져오기 위해서
