...
public class BoardDAO {
	...
	/*
	 * public ArrayList<HashMap<String, Object>> searchBoard(HashMap<String, Object>
	 * map){ BoardMapper mapper = session.getMapper(BoardMapper.class);
	 * ArrayList<HashMap<String, Object>> list = null;
	 * 
	 * try { list = mapper.searchBoard(map); } catch (Exception e) {
